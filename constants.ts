import { BarChart3, Code, CreditCard, GitBranch, LayoutDashboard, Link, Package, Repeat, Settings, Share2, SlidersHorizontal, Users, DollarSign, Shield, ShieldCheck, ShieldAlert, ShieldX, HelpCircle, AlertTriangle, UserCheck } from 'lucide-react';
import type { MenuItem, Notification, TeamMember, DashboardData, PaymentMethod, Affiliate, AffiliateTier, AffiliateStatus, TransactionStatus, SubscriptionStatus, Subscription, Webhook, Integration, ApiKey, Transaction, Product, BillingHistoryEntry, TransactionRiskLevel, PromotionalMaterial, SalesHistoryData, AffiliateTierConfig, PaymentLink } from './types';
